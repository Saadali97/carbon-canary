...
function InvoiceDashboard({ data, onReset }) {
  const { fileName, totalCO2kg, totalCO2t, co2Rating, co2Color, emissionBreakdown, results, strong, weak, overallScore, supplierName, invoiceNumber, invoiceDate, confidence, notes } = data;
...
function ReportDashboard({ data, onReset }) {
  const { fileName, overallScore, overallBenchmark, results, strong, weak } = data;
